      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[1.2fr_.8fr]">
        <section className="rounded-[1.5rem] border border-border bg-surface p-5 sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold">Contenu déclaré</p>
              <p className="text-xs text-muted-foreground">
                {shipment.weightKg} kg connus au total
              </p>
            </div>
          </div>
            ...
            {shipment.lines.map((line) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {line.hasPhoto
                      ? "Photos de contrôle ajoutées"
                      : "Photos encore attendues"}
                  </p>
                </div>
          ...
          {confirming ? (
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              <p className="text-sm text-muted-foreground">
                La demande sera refermée. Aucun paiement n&apos;ayant été confirmé, rien
                ne sera débité.
              </p>
            ...
            <button
              ...
              className="text-sm font-medium text-muted-foreground hover:text-error"
            >
