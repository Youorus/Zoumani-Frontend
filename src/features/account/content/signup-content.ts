...
export const signupContent: Record<HomeLanguage, SignupContent> = {
  fr: {
    ...
    fields: {
      ...
      terms: "J’accepte les conditions d’utilisation et la politique de confidentialité de Zoumani.",
    },
    secureNote: "Vos données sont protégées et utilisées uniquement pour sécuriser votre expérience Zoumani.",
    ...
    roles: {
      sender: {
        ...
        benefits: ["Recherches et alertes mémorisées", "Suivi du colis centralisé", "Protection et paiements sécurisés"],
        submit: "Créer mon compte expéditeur",
        successTitle: "Bienvenue dans votre espace expéditeur.",
        successDescription: "Votre recherche est conservée. Vous pourrez maintenant préparer votre premier envoi.",
      },
      traveler: {
        ...
        benefits: ["Rémunération annoncée avant l’accord", "Colis vérifiés avec vous", "Avis, points et profil de confiance"],
        submit: "Créer mon compte voyageur",
        successTitle: "Bienvenue parmi les voyageurs Zoumani.",
        successDescription: "Votre espace est prêt. La vérification de profil sera votre prochaine étape.",
      },
    },
  },
  en: {
    ...
    roles: {
      sender: {
        ...
        description: "Find verified travelers, conversations and parcel protection in one simple space.",
        story: "From your hands to theirs, with updates all along the way.",
        benefits: ["Saved searches and alerts", "Centralised parcel tracking", "Protection and secure payments"],
        submit: "Create my sender account",
        successTitle: "Welcome to your sender space.",
        successDescription: "Your search is saved. You can now prepare your first shipment.",
      },
      traveler: {
        ...
        description: "Publish departures, choose what you carry and build your reputation at your own pace.",
        story: "A little space in your luggage can mean a great deal to someone.",
        benefits: ["Payment shown before you agree", "Parcels checked with you", "Reviews, points and a trusted profile"],
        submit: "Create my traveler account",
        successTitle: "Welcome to the Zoumani traveler community.",
        successDescription: "Your space is ready. Profile verification will be your next step.",
      },
    },
  },
};
